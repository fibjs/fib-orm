...
import { FxOrmCoreCallbackNS, FxOrmDialect } from "../../orm-core/index"
import { IProperty } from "../../orm-property/index"
import { IPropTransformer } from '../../orm-property/Property';
...
export namespace FxOrmSqlDDLSync__Dialect{
    ...
    export interface Dialect<ConnType extends IDbDriver.ISQLConn> extends FxOrmDialect.DDLDialect<ITypedDriver<ConnType>> {
        ...
        convertIndexes?: <T extends FxOrmSqlDDLSync__DbIndex.DbIndexInfo>(
