...
import { FxDbDriverNS, IDbDriver } from "../db-driver/index";
import SqlQuery = require("../sql-query/Query");
...
/** @deprecated use require('../sql-query/Query').Text instead */
export const Text = SqlQuery.Text;
/** @deprecated use require('../sql-query/Query').comparators.between instead */
export const between = SqlQuery.comparators.between;
/** @deprecated use require('../sql-query/Query').comparators.not_between instead */
export const not_between = SqlQuery.comparators.not_between;
/** @deprecated use require('../sql-query/Query').comparators.like instead */
export const like = SqlQuery.comparators.like;
/** @deprecated use require('../sql-query/Query').comparators.not_like instead */
export const not_like = SqlQuery.comparators.not_like;
/** @deprecated use require('../sql-query/Query').comparators.eq instead */
export const eq = SqlQuery.comparators.eq;
/** @deprecated use require('../sql-query/Query').comparators.ne instead */
export const ne = SqlQuery.comparators.ne;
/** @deprecated use require('../sql-query/Query').comparators.gt instead */
export const gt = SqlQuery.comparators.gt;
/** @deprecated use require('../sql-query/Query').comparators.gte instead */
export const gte = SqlQuery.comparators.gte;
/** @deprecated use require('../sql-query/Query').comparators.lt instead */
export const lt = SqlQuery.comparators.lt;
/** @deprecated use require('../sql-query/Query').comparators.lte instead */
export const lte = SqlQuery.comparators.lte;
/** @deprecated use require('../sql-query/Query').comparators.in instead */
module.exports.in = SqlQuery.comparators.in;
/** @deprecated use require('../sql-query/Query').comparators.not_in instead */
