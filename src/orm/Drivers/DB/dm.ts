import { Driver as FxDbDriver } from '../../../db-driver/index';
...
const Driver = FxDbDriver.getDriver('dm');

export class Database extends Driver implements FxOrmDb.Database<Class_DbConnection> {
