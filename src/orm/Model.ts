...
import { FxOrmSqlDDLSync } from '../sql-ddl-sync/index';
...
export const Model = function (
	...
	const createInstanceSync = function (
		...
		OneAssociation.autoFetch(instance, one_associations, assoc_opts, false);
		ManyAssociation.autoFetch(instance, many_associations, assoc_opts, false);
		ExtendAssociation.autoFetch(instance, extend_associations, assoc_opts, false);
