...
export namespace FxSqlQuerySql {
	...
	export type SqlFromTableInput = import('../../knex/types').Knex.Raw | import('../../knex/types').Knex.QueryBuilder
	export type SqlTableTuple = [table: string | `(${string})`| SqlFromTableInput, alis: string]
	...
	export interface QueryFromDescriptor {
		// table
		table: string | import('../../knex/types').Knex.Raw | import('../../knex/types').Knex.QueryBuilder
		// table alias
