...
export function maybeKnexSubQuery(input: any): input is import('../knex/types').Knex.QueryBuilder {
	return typeof input?.toQuery === "function";
}

export function maybeKnexRaw(input: any): input is import('../knex/types').Knex.Raw {
	return typeof input?.toQuery === "function";
}

export function maybeKnexRawOrQueryBuilder(input: any): input is import('../knex/types').Knex.QueryBuilder | import('../knex/types').Knex.Raw {
	return typeof input?.toQuery === "function";
}
