...
export declare function buildBaseConditionsToQuery(this: FxOrmDMLDriver.DMLDriver, q: FxSqlQueryChainBuilder.ChainBuilder__Select, base_table: string, base_conditions?: FxSqlQuerySubQuery.SubQueryConditions, top_conditions?: FxSqlQuerySubQuery.SubQueryConditions): FxSqlQueryChainBuilder.ChainBuilder__Select;
