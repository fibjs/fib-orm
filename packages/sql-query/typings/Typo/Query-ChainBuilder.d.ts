...
export declare namespace FxSqlQueryChainBuilder {
    type QueryWhereConditionPayloadUnit = FxSqlQuerySql.DetailedQueryWhereCondition | string | null;
    interface ChainBuilderOptions extends FxSqlQuery.QueryOptions {
    }
    ...
    interface ChainBuilder__Select extends ChainBuilder, FxSqlAggregation.SupportedAggregationsMixin, ChainBuilderPaginationMixin, ChainBuilderSortMixin {
        ...
        from: {
            ...
            (table: FxSqlQuerySql.SqlTableInputType, from_id: FxSqlQueryHelpler.Arraiable<string>, to_id: FxSqlQueryHelpler.Arraiable<string>): ChainBuilder__Select;
            (table: FxSqlQuerySql.SqlTableInputType, from_id: FxSqlQueryHelpler.Arraiable<string>, to_table: string, to_id: FxSqlQueryHelpler.Arraiable<string>, fromOpts?: FxSqlQuerySql.QueryFromDescriptorOpts): ChainBuilder__Select;
        };
        [extra: string]: any;
    }
    ...
    interface ChainBuilder__Remove extends ChainBuilder, ChainBuilderPaginationMixin {
